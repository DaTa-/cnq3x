...
void SV_Frame( int msec ) {
	...
	if (!com_dedicated->integer)
		SV_BotFrame( /*sv.time*/svs.time + sv.timeResidual );
	...
	// if time is about to hit the 32nd bit, kick all clients and clear sv.time
	...
	while ( sv.timeResidual >= frameMsec ) {
		...
		VM_Call( gvm, GAME_RUN_FRAME, /*sv.time*/svs.time );
	}
